...
tape('storage: can load an empty storage', (t) => {
...
tape('storage: can persist', (t) => {
	storage1.saveEntry('/file/test1', { itemId: 'test1', files: [{ path: '/file/test1' }] }, (err) => {
		t.error(err)
